...
import { h, Logger, Time as Time2 } from "koishi";
...
function renderGrid(layout) {
  ...
  return /* @__PURE__ */ jsx("g", { class: "grid", children: Array.from({ length: CHART.gridLines }, (_, idx) => {
    ...
    return [
      ...
      /* @__PURE__ */ jsx("text", { x: CHART.left - 12, y: y + 4, children: formatNum(value) })
    ];
  }) });
}
  ...
  return coords.map((c, idx) => {
    ...
    return /* @__PURE__ */ jsx(
      "text",
      {
        ...
        children: parts[1] ? parts.map((part, pIdx) => /* @__PURE__ */ jsx("tspan", { x: c.x, dy: pIdx ? "13" : "0", children: part })) : c.point.label
      }
    );
  });
}
...
function chart(points, info, mode = "both") {
  if (!points.length) return /* @__PURE__ */ jsx("div", { class: "empty-chart", children: "暂无用量数据" });
  ...
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      children: [
        ...
        showLine && layout.totalLine ? /* @__PURE__ */ jsx("path", { class: "line line-total", d: layout.totalLine }) : null,
        mode === "line" && layout.inputLine ? /* @__PURE__ */ jsx("path", { class: "line line-input", d: layout.inputLine }) : null,
        mode === "line" && layout.outputLine ? /* @__PURE__ */ jsx("path", { class: "line line-output", d: layout.outputLine }) : null,
...
function pluginSection(plugins) {
  ...
  return /* @__PURE__ */ jsxs("section", { class: "plugin-section", children: [
    /* @__PURE__ */ jsxs("div", { class: "section-title-row", children: [
      /* @__PURE__ */ jsx("h2", { children: "用量明细" }),
      /* @__PURE__ */ jsx("span", { class: "sort-chip", children: "按 Token 使用降序排列" })
    ] }),
    /* @__PURE__ */ jsxs("div", { class: "plugin-list-head", children: [
      /* @__PURE__ */ jsx("span", { children: "来源插件" }),
      /* @__PURE__ */ jsx("span", { class: "text-center", children: "用量占比" }),
      /* @__PURE__ */ jsx("span", { class: "text-right", children: "Token 使用" }),
      /* @__PURE__ */ jsx("span", { class: "text-right", children: "请求次数" })
    ] }),
    /* @__PURE__ */ jsx("ul", { class: "plugin-list", children: displayPlugins.map((plugin, idx) => {
      ...
      return /* @__PURE__ */ jsxs("li", { class: "plugin-list-row", children: [
        /* @__PURE__ */ jsxs("div", { class: "plugin-name-cell", children: [
          /* @__PURE__ */ jsx(
            "span",
            {
        ...
        /* @__PURE__ */ jsxs("div", { class: "plugin-progress-wrapper", children: [
          /* @__PURE__ */ jsx("div", { class: "plugin-progress-bar", children: /* @__PURE__ */ jsx(
            "div",
            {
        ...
        /* @__PURE__ */ jsx("span", { class: "plugin-number text-right", children: formatNum(plugin.tokens) }),
        /* @__PURE__ */ jsx("span", { class: "plugin-number text-right", children: formatNum(plugin.calls) })
      ] });
    }) })
  ] });
}
...
function renderLegend(info, mode = "both") {
  const showLine = mode === "both" || mode === "line";
  const showBar = mode === "both" || mode === "bar";
  return /* @__PURE__ */ jsxs("div", { class: "chart-legend", children: [
    mode === "line" ? /* @__PURE__ */ jsxs("div", { class: "legend-item", children: [
      /* @__PURE__ */ jsx(
        "span",
        {
    ...
    mode === "both" && showLine ? /* @__PURE__ */ jsxs("div", { class: "legend-item", children: [
      /* @__PURE__ */ jsx(
        "span",
        {
          class: "legend-color-indicator legend-total-indicator",
    ...
    showBar ? Object.entries(info.colorMap).map(([model, color]) => /* @__PURE__ */ jsxs("div", { class: "legend-item", children: [
      /* @__PURE__ */ jsx(
        "span",
        {
...
function pageHtml(data, theme, mode = "both") {
  ...
  return "<!doctype html>" + String(
    /* @__PURE__ */ jsxs("html", { lang: "zh-CN", children: [
      /* @__PURE__ */ jsxs("head", { children: [
        ...
        /* @__PURE__ */ jsx("title", { children: "ChatLuna Token 用量" }),
        /* @__PURE__ */ jsx("style", { children: CSS })
      ] }),
      /* @__PURE__ */ jsx("body", { children: /* @__PURE__ */ jsx("div", { class: `stage theme-${theme}`, children: /* @__PURE__ */ jsxs("main", { class: "paper-content", children: [
        /* @__PURE__ */ jsxs("header", { class: "hero-header", children: [
          /* @__PURE__ */ jsx("h1", { class: "hero-title", children: "ChatLuna Token 用量" }),
          /* @__PURE__ */ jsxs("div", { class: "time-strip", children: [
            /* @__PURE__ */ jsx("span", { class: "time-label", children: "统计周期" }),
            /* @__PURE__ */ jsx("strong", { class: "time-value", children: formatDate(data.start) }),
            /* @__PURE__ */ jsx("i", { class: "time-sep", children: "至" }),
            /* @__PURE__ */ jsx("strong", { class: "time-value", children: formatDate(data.end) })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("section", { class: "stats-row", children: [
          /* @__PURE__ */ jsxs("div", { class: "stat-cell", children: [
            /* @__PURE__ */ jsx("div", { class: "stat-label", children: "使用 Token" }),
            /* @__PURE__ */ jsx("div", { class: "stat-value", children: formatNum(data.totalTokens) })
          ] }),
          /* @__PURE__ */ jsxs("div", { class: "stat-cell", children: [
            /* @__PURE__ */ jsx("div", { class: "stat-label", children: "请求次数" }),
            /* @__PURE__ */ jsx("div", { class: "stat-value", children: formatNum(data.calls) })
          ] }),
          /* @__PURE__ */ jsxs("div", { class: "stat-cell", children: [
            /* @__PURE__ */ jsx("div", { class: "stat-label", children: "TPM 峰值" }),
            /* @__PURE__ */ jsx("div", { class: "stat-value", children: formatNum(data.tpm) })
          ] }),
          /* @__PURE__ */ jsxs("div", { class: "stat-cell", children: [
            /* @__PURE__ */ jsx("div", { class: "stat-label", children: "RPM 峰值" }),
            /* @__PURE__ */ jsx("div", { class: "stat-value", children: formatNum(data.rpm) })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("section", { class: "chart-container", children: [
          chart(data.points, info, mode),
          renderLegend(info, mode)
        ] }),
        pluginSection(data.plugins),
        /* @__PURE__ */ jsxs("footer", { class: "footer", children: [
          "Generated by ",
          /* @__PURE__ */ jsx("span", { children: "ChatLuna" }),
          " &",
          " ",
          /* @__PURE__ */ jsx("span", { children: "Koishi" })
        ] })
      ] }) }) })
    ] })
  );
...
var ChatLunaUsageService = class extends DataService {
  ...
  async sendTokens(session, options, args) {
    ...
    try {
      ...
      await session.send(
        typeof image === "string" ? h.text(image) : h.image(image, "image/png")
      );
    } catch (e) {
      logger.error(e);
      return formatTokenReport(report);
  ...
  withDefaults(input) {
    ...
    const start = input.start ? new Date(input.start) : period === "year" ? new Date(end.getFullYear() - 1, end.getMonth(), end.getDate()) : period === "month" ? new Date(end.getFullYear(), end.getMonth() - 11, 1) : new Date(+end - this.config.recentDays * Time2.day);
    return {
      ...input,
      period,
...
export {
  ChatLunaUsageService as ChatLunaUsage,
  Config,
  apply,
  inject,
  name
